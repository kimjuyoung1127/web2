  ...
  return (
    <section className="py-20 bg-gradient-to-r from-orange to-orange-400">
      <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
        <motion.h2 
          className="font-playfair text-4xl md:text-5xl font-bold text-warm-orange drop-shadow-lg mb-6"
        ...
        >
          우리 아이의 특별한 시간을<br />
          <span className="text-orange-200 font-extrabold drop-shadow">지금 시작하세요</span>
        </motion.h2>
        
        <motion.p 
          className="font-bold text-warm-orange drop-shadow-lg mb-6"
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
